const FinalCTA = () => {
  return (
    <section id="cta" style={{ padding: '160px 0', borderTop: '1px solid rgba(255,255,255,.06)', position: 'relative', overflow: 'hidden' }}>
      <img src="./design_system/assets/graphic-holo-knot.png" alt=""
        style={{
          position: 'absolute', left: '50%', top: '50%',
          transform: 'translate(-50%, -50%)', width: 920, height: 920,
          objectFit: 'contain', opacity: 0.32, pointerEvents: 'none',
      ...
      <div className="container" style={{ position: 'relative', textAlign: 'center' }}>
        ...
        <h2 style={{
          ...
          margin: '0 auto 40px', fontWeight: 400, maxWidth: 1040,
        }}>
