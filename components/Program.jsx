...
const Program = () => {
  const blocks = [
    ...
    },
    {
      ...
      body: 'Не курс с лектором. Рядом — те, кто прямо сейчас перестраивает свой бизнес под ИИ. Команда hakku отвечает в течение дня.',
    },
    {
    ...
    {
      tag: 'Hakku для крупнейших',
      title: 'Методика, по которой учат Яндекс',
      body: 'Те же методические рамки, по которым команда hakku обучает 27+ крупнейших компаний страны, — адаптированы под собственника малого и среднего бизнеса.',
    },
  ];
