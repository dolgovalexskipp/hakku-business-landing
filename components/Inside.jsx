const Inside = () => {
  const items = [
    ...
    { n: '02', title: 'Инструменты', body: 'Готовые гайды и шаблоны по пяти ИИ-ролям. Каждый месяц — один сценарий до готового внедрения.', stat: '−60% времени на рабочие задачи · Stanford × World Bank, 2025' },
