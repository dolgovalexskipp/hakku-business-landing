  ...
  const tiers = [
    {
      ...
      desc: 'Войдите в поток сами. Применяйте ИИ лично, определите процессы для следующего шага.',
      avatars: [
    ...
    },
    {
      ...
      desc: 'Перестройте операционку: ИИ встроен в несколько функций, вся команда в общем потоке.',
      avatars: [
        ...
        <div style={{ marginBottom: 32, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32 }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <h2 style={{
              ...
              Выберите свою скорость движения.
            </h2>
          </div>
