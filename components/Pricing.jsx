  ...
  const tiers = [
    {
      ...
      desc: 'Начните трансформацию лично. Применяйте ИИ в своей работе, определите процессы для следующего этапа.',
      avatars: [
    ...
    },
    {
      ...
      desc: 'Подключите ядро команды и вместе спроектируйте первого ИИ-сотрудника под один процесс.',
      popular: true,
      avatars: [
    ...
    },
    {
      ...
      desc: 'Перестройте операционку: ИИ встроен в несколько функций, вся команда работает системно.',
      avatars: [
    ...
    },
    {
      ...
      desc: 'Индивидуальный маршрут для крупных компаний — с интеграцией под Ваши процессы.',
      avatars: [],
    },
  ];
        ...
        <div style={{ marginBottom: 32, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 32 }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <h2 style={{
              ...
              Тариф под этап Вашей трансформации.
            </h2>
          </div>
