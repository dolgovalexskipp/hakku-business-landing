  ...
  const tiers = [
    {
      ...
      desc: 'Доступ ко всему контенту клуба для Вас одного. Определите, где в Вашем бизнесе AI даст прибыль, и запустите первый инструмент лично.',
      avatars: [
    ...
    },
    {
      ...
      desc: 'Индивидуальный формат для крупных компаний — с интеграцией клуба под конкретные процессы.',
      avatars: [],
    },
  ];
