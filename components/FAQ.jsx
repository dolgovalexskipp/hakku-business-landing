...
const FAQ = () => {
  const qa = [
    ...
    { q: 'Я не айтишник. Разберусь?', a: 'Продукт сделан для собственников, а не для разработчиков. Мы идём от функции и боли бизнеса к готовому ИИ-сотруднику — без кода и теории, на ваших процессах.' },
    { q: 'Это про экономию времени или про деньги?', a: 'Про деньги. Мы заходим с вопроса «какой процесс, усиленный ИИ, добавит к выручке или марже» и доводим до измеримого роста прибыли. Экономия времени — приятный побочный эффект.' },
    { q: 'Что с безопасностью данных и законом РФ?', a: 'Отдельный блок методики: как дать ИИ доступ к документам компании, не нарушая 152-ФЗ и не отдавая данные в публичные нейросети. На тарифе Компания — шаблоны корпоративного VPN и закрытого контура данных.', security: true },
    { q: 'Можно с командой?', a: 'Да. ПРО — только собственник. МАКС — собственник + ответственный за ИИ. Компания — вся операционная команда, по договорённости. Состав и цены — в блоке «Тарифы».' },
    { q: 'Можно зафиксировать цену навсегда?', a: 'Подписавшись до 26 июня, вы фиксируете пожизненный доступ по цене запуска — она не вырастет даже после общего повышения.' },
  ];
