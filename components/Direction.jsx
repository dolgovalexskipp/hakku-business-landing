  ...
  const stages = [
    {
      ...
      body: 'Прошли разборы и воркшопы клуба, определили 2-3 процесса, в которых AI даст измеримый эффект. Запустили первый инструмент лично — он уже работает на Вас.',
    ...
    <section id="direction" style={{ padding: '140px 0', borderTop: '1px solid rgba(0,0,0,.06)', background: '#fafafa' }}>
      <div className="container">
        <div style={{ marginBottom: 56, maxWidth: 980 }}>
          <div className="eyebrow-tag" style={{ marginBottom: 32 }}>Этапы внутри клуба</div>
          <h2 style={{
          ...
          <p style={{ fontSize: 17, color: 'rgba(0,0,0,.65)', lineHeight: 1.55, margin: 0, maxWidth: 760 }}>
            Подписка — это постоянный процесс, а не разовое обучение. В первые шесть месяцев Вы проходите путь от понимания, где AI принесёт прибыль, до встроенного в операционку AI. Дальше клуб продолжает обновлять методики — AI меняется ежемесячно.
          </p>
        </div>
