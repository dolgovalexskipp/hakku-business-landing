// ИИ-сотрудники — interactive catalog. Click an employee → функция / боль / решение.
const Staff = () => {
  const staff = [
    {
    ...
    <section id="staff" className="section-pad section-line">
      <div className="container">
        <div style={{ marginBottom: 56, maxWidth: 920 }}>
          <div style={{ fontSize: 11, color: 'rgba(0,0,0,.5)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 28 }}>Каталог · ось продукта</div>
          <h2 style={{ fontFamily: 'Tektur, sans-serif', fontSize: 'clamp(2.2rem,5vw,4rem)', lineHeight: 1.05, letterSpacing: '-0.02em', margin: '0 0 22px', fontWeight: 400, color: '#000' }}>
            5 ИИ-сотрудников, которые вы соберёте за первые пять месяцев.
          </h2>
          <p style={{ fontSize: 17, color: 'rgba(0,0,0,.6)', lineHeight: 1.55, margin: 0, maxWidth: 720 }}>
            Каждый месяц сообщество вместе настраивает одного ИИ-сотрудника под конкретную функцию бизнеса — от помощника собственника до ассистента по продажам. Выберите роль — увидите функцию, боль и решение. Шаблоны остаются у вас навсегда.
          </p>
        </div>
