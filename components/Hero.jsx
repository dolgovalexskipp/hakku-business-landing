const Hero = () => {
  return (
    <section style={{ position: 'relative', padding: '120px 0 140px', overflow: 'hidden', minHeight: '80vh' }}>
      <img src="./design_system/assets/graphic-holo-ring.png" alt=""
        style={{
          position: 'absolute', right: -260, top: -120, width: 900, height: 900,
          objectFit: 'contain', opacity: .9, pointerEvents: 'none',
      ...
      <div className="container" style={{ position: 'relative' }}>
        <div style={{ maxWidth: 880, animation: 'hakku-fade-up 600ms cubic-bezier(0.2, 0.8, 0.2, 1) both' }}>
          ...
          <p style={{
            fontSize: 19, color: 'rgba(255, 255, 255, .72)', lineHeight: 1.55,
        ...
        <div style={{
          ...
          <span style={{ fontSize: 13, color: 'rgba(255,255,255,.5)', letterSpacing: '0.04em' }}>УЖЕ УЧИМ</span>
