...
function Schedule({ nav = ()=>{} }) {
  ...
  const ev = {
    ...
    22: [ { c:'ink',    t:'Вебинар: Оперативка на минималках · запись в базе' } ],
  ...
  const upcoming = [
    ...
    { d:'22', m:'июл', dow:'СР', time:'—', kind:'Вебинар', c:'blue', t:'Оперативка на минималках', who:'Максим Желепа + Q&A · запись в базе' },
