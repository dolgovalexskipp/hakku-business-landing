...
const MATERIALS = [
  ...
  { kind:'Гайд',     k:'book',   title:'Второй мозг',                 sub:'Контекст о вас, который читает любая нейросеть', auth:'alex',    read:'10 мин', status:'live', track:'personal',    topics:['Контекст','Личная польза'],       tier:'pro', md:'/materials/second-brain/second-brain-skill.md', href:'/materials/second-brain/' },
  { kind:'Гайд',     k:'book',   title:'Единый мозг компании',        sub:'Один контекст для всех ваших ИИ',                auth:'alex',    read:'10 мин', status:'live', track:'team',        topics:['Контекст','Компания'],            tier:'max', md:'/materials/company-brain/company-brain-skill.md', href:'/materials/company-brain/' },
  { kind:'Гайд',     k:'book',   title:'ИИ-ассистент собственника',   sub:'Из диктофона — в готовую повестку и поручения',  auth:'alex',    read:'10 мин', status:'live', track:'first-agent', topics:['Продуктивность','Кейс','Рутина'], tier:'pro', md:'/materials/assistent-sobstvennika/assistent-sobstvennika-skill.md', href:'/materials/assistent-sobstvennika/' },
  { kind:'Гайд',     k:'book',   title:'Где ИИ врёт — и как не попасться', sub:'Эхо-камера, выдумки и проверка на доверие',  auth:'alex',    read:'8 мин',  status:'live', track:'personal',    topics:['Безопасность','Личная польза'],   tier:'pro', md:'/materials/gde-ii-vret/gde-ii-vret-skill.md', href:'/materials/gde-ii-vret/' },
